...
//				this.setBottomPosition(index);
	 ...
	 /**隐藏底部 禁用上拉更多**/
	  ...
	  headContentHeight = headView.getMeasuredHeight() + 10;//头部高度
	  ...
	  reverseAnimation.setDuration(250*2);
